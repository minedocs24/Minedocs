...
/**
 * Template Name: Profilo Utente Movimenti
 *
 * 
 *
 * @package Bootscore
...
<!-- <nav class="navbar navbar-light bg-light d-lg-none">
    <div class="container-fluid">
        ...
        <span class="navbar-brand mb-0">I tuoi movimenti</span>
    </div>
</nav> -->
...
<div class="d-flex overflow-hidden w-100">
    ...
    <div id="sidebarDesktop-profilo-utente" class="p-3 d-none d-lg-block flex-shrink-0" style="min-width: 250px; width: 350px;">
        <?php get_template_part('template-parts/profilo-utente/sidebar-new', null, array('current_page' => 'movimenti')); ?>
    </div>
    ...
    <div class="flex-grow-1 overflow-auto p-4">
        <?php get_template_part('template-parts/profilo-utente/sezione-movimenti'); ?>
    </div>
</div>
