...
<div id="page" class="site">
  ...
  <header id="masthead" class="<?= apply_filters('bootscore/class/header', 'sticky-top bg-body-tertiary'); ?> site-header">
    ...
    <nav id="nav-main" class="navbar <?= apply_filters('bootscore/class/header/navbar/breakpoint', 'navbar-expand-lg'); ?>">
      ...
      <div class="<?= apply_filters('bootscore/class/container', 'container', 'header'); ?>">
        ...
        <a class="navbar-brand" href="<?= esc_url(home_url()); ?>">
          <img  src="<?= esc_url(apply_filters('bootscore/logo', get_stylesheet_directory_uri() . '/assets/img/logo/logo-minedocs.svg', 'default')); ?>" alt="<?php bloginfo('name'); ?> Logo" class="d-td-none me-2 header-logo">
          <img  src="<?= esc_url(apply_filters('bootscore/logo', get_stylesheet_directory_uri() . '/assets/img/logo/logo-minedocs.svg', 'theme-dark')); ?>" alt="<?php bloginfo('name'); ?> Logo" class="d-tl-none me-2 header-logo">
        </a>  
    ...
    <!-- Box Points -->
    <div class="box-points fixed-top-center">

        <?php get_template_part('template-parts/commons/box-points', null, null); ?> 
        <a href="<?php echo wp_logout_url(home_url()); ?>" class="btn btn-outline-secondary">Logout</a>
    </div>
