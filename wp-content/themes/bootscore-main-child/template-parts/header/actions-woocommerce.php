...
if ( is_account_page() || is_checkout() ) {
 // Do nothing
  ...
  <a href="<?php echo LOGIN_PAGE; ?>" class="<?= apply_filters('bootscore/class/header/button', 'btn btn-outline-secondary', 'account-toggler'); ?> ms-1 ms-md-2 account-toggler" type="button" aria-controls="offcanvas-user">
    <i class="fa-solid fa-user"></i><span class="visually-hidden-focusable">Account</span>
  </a>
