...
<div id="sezione-miei-documenti" class="row mt-5">
    <h3 class="section-title mb-4">I miei documenti</h3>
            ...
            <div class="swiper-wrapper">
                <?php foreach ($documenti as $documento) : ?>
                    <div class="swiper-slide">
                        <?php get_template_part('/template-parts/profilo-utente/mio-documento', null, array('documento' => $documento, 'sezione' => 'miei-documenti')); ?>
                    </div>
                <?php endforeach; ?>
            </div>
